...
public class pelangganCRUD {
    ...
    public void SimpanPELANGGANStatement(String id_pelanggan,String nama_pelanggan,String gender, String alamat) {
        try{
            if (duplicateKey("pelanggan", "id_pelanggan", id_pelanggan)) {
                JOptionPane.showMessageDialog(null,"ID PELANGGAN SUDAH TERINPUT");
            } else {
                String SQL = "INSERT INTO pelanggan (id_pelanggan, nama_pelanggan, gender, alamat) VALUES('"+ id_pelanggan + "','" + nama_pelanggan + "','" + gender + "','" + alamat + "')";
    ...
    public void SimpanPELANGGANPreparedstmt(String id_pelanggan,String nama_pelanggan,String gender,String alamat) {
    try {
        if (duplicateKey("pelanggan", "id_pelanggan", id_pelanggan)) {
            JOptionPane.showMessageDialog(null,"ID PELANGGAN SUDAH TERINPUT");
        } else {
            String SQL = "INSERT INTO pelanggan (id_pelanggan, nama_pelanggan, gender, alamat) VALUES (?, ?, ?, ?)";
            PreparedStatement simpan = getKoneksi().prepareStatement(SQL);
            simpan.setString(1, id_pelanggan);
            simpan.setString(2, nama_pelanggan);
            simpan.setString(3, gender);
